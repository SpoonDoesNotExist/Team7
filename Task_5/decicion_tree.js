...
class DecicionTree {
    ...
    to_terminal(group) {
        ...
        return { value: the_most_frequent_key, id: `node-${++id_counter}` };
    }
    ...
    get_split(dataset) {
        ...
        return { 'index': b_index, 'value': b_value, 'groups': b_groups, id: `node-${++id_counter}` }
    }
